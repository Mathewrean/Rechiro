...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('order_number', 'customer', 'status', 'total_amount', 'fulfillment_method', 'created_at')
...
class OrderItemAdmin(admin.ModelAdmin):
    list_display = ('order', 'fish_name', 'fisherman', 'weight_kg', 'total_price', 'fulfillment_status')
...
class PaymentTransactionAdmin(admin.ModelAdmin):
    list_display = ('transaction_id', 'order', 'amount', 'phone_number', 'status', 'mpesa_receipt_number', 'created_at')
...
class DeliveryAdmin(admin.ModelAdmin):
    list_display = ('order', 'status', 'fisherman', 'estimated_delivery', 'actual_delivery', 'created_at')
    list_filter = ('status', 'created_at')
